    ...
    <section className="py-16 bg-gradient-to-r from-gray-800 via-gray-900 to-black text-gray-100">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-3xl font-extrabold animate-bounce text-pink-500 transition-colors duration-2000 animate-pulse">
            COMING SOON
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {movies.map((movie, index) => (
            <div key={movie.id} className="bg-gray-900 rounded-lg overflow-hidden shadow-lg transform hover:scale-105 hover:shadow-2xl transition-transform animate-move">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-300 text-sm mb-2">Language: {movie.language}</p>
